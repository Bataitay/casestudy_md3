             ...
             <div class="container mx-auto px-6 py-1">
               <div class="bg-white shadow-md rounded my-6 p-5">
                 ...
                 <div class="text-center mt-16">
                   ...
                   <a href="{{route('permission.index') }}" class="bg-red-600 text-white font-bold px-5 py-1.5 rounded focus:outline-none shadow hover:bg-red-600 transition-colors ">cancel</a>
                 </div>
               </div>
             </div>x
         </main>
